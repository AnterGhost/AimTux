...
void SetupMainMenuBar()
{
	if (ImGui::BeginMainMenuBar())
	{
		...
		{
			ImGui::Selectable("Skin Changer Window", &SkinModelChanger::showWindow, 0, ImVec2(ImGui::CalcTextSize("Skin Changer Window", NULL, true).x, 0.0f));
			ImGui::SameLine();
		}
...
//	static int currentWeaponSkin = Settings::Skinchanger::skinsCT.find((ItemDefinitionIndex) currentWeapon) != Settings::Skinchanger::skinsCT.end() ? Settings::Skinchanger::skinsCT.at((ItemDefinitionIndex) currentWeapon).fallbackPaintKit : -1;
...
//
//							auto keyExists = Settings::Skinchanger::skinsCT.find(it.first);
//							if (keyExists == Settings::Skinchanger::skinsCT.end())
//								currentWeaponSkin = -1;
//							else
//								currentWeaponSkin = Settings::Skinchanger::skinsCT.at(it.first).fallbackPaintKit;
//						}
//					ImGui::PopID();
//				}
//			ImGui::ListBoxFooter();
...
//					currentWeaponSkin = Settings::Skinchanger::skinsCT.at(isCT == 1 ? ItemDefinitionIndex::WEAPON_KNIFE : ItemDefinitionIndex::WEAPON_KNIFE_T).fallbackPaintKit;
//				}
//				ImGui::PopID();
//			}
//		ImGui::ListBoxFooter();
...
//			{
//				if (Settings::Skinchanger::skinsCT.find((ItemDefinitionIndex) currentWeapon) == Settings::Skinchanger::skinsCT.end())
//					Settings::Skinchanger::skinsCT[isCT == 1 ? ItemDefinitionIndex::WEAPON_KNIFE : ItemDefinitionIndex::WEAPON_KNIFE_T] = AttribItem_t();
//
//				skin = Settings::Skinchanger::skinsCT.at(isCT == 1 ? ItemDefinitionIndex::WEAPON_KNIFE : ItemDefinitionIndex::WEAPON_KNIFE_T);
...
//				else
//					skin = Settings::Skinchanger::skinsCT.at((ItemDefinitionIndex) currentWeapon);
//			}
//
...
//			{
//				if (Settings::Skinchanger::skinsCT.find((ItemDefinitionIndex) currentWeapon) == Settings::Skinchanger::skinsCT.end())
//					Settings::Skinchanger::skinsCT[(ItemDefinitionIndex) currentWeapon] = AttribItem_t();
//
//				Settings::Skinchanger::skinsCT.at(isCT == 1 ? ItemDefinitionIndex::WEAPON_KNIFE : ItemDefinitionIndex::WEAPON_KNIFE_T) = {
...
//					Settings::Skinchanger::skinsCT[(ItemDefinitionIndex) currentWeapon] = AttribItem_t();
//
//				Settings::Skinchanger::skinsCT.at((ItemDefinitionIndex) currentWeapon) = {
//						(ItemDefinitionIndex) currentWeapon,
//						currentWeaponSkin == 0 ? -1 : currentWeaponSkin,
//						weaponWear,
//						weaponSkinSeed,
...
//	static int currentGloveSkin = Settings::Skinchanger::skinsCT.find(ItemDefinitionIndex::GLOVE_T_SIDE) != Settings::Skinchanger::skinsCT.end() ? Settings::Skinchanger::skinsCT.at(ItemDefinitionIndex::GLOVE_T_SIDE).fallbackPaintKit : 10006;
...
//						currentGloveSkin = Settings::Skinchanger::skinsCT.find(ItemDefinitionIndex::GLOVE_T_SIDE) != Settings::Skinchanger::skinsCT.end() ? Settings::Skinchanger::skinsCT.at(ItemDefinitionIndex::GLOVE_T_SIDE).fallbackPaintKit : 10006;
//					}
//					ImGui::PopID();
//				}
//			ImGui::ListBoxFooter();
...
//		{
//			if (Settings::Skinchanger::skinsCT.find(ItemDefinitionIndex::GLOVE_T_SIDE) == Settings::Skinchanger::skinsCT.end())
//				Settings::Skinchanger::skinsCT[ItemDefinitionIndex::GLOVE_T_SIDE] = AttribItem_t();
//
//			Settings::Skinchanger::skinsCT.at(ItemDefinitionIndex::GLOVE_T_SIDE) = {
